        ...
        <div class="row shuffle-wrapper portfolio-gallery">
          ...
          <div class="col-lg-3 col-sm-6 col-md-6 mb-4 shuffle-item" data-groups="['camping']">
            <div class="position-relative doctor-inner-box">
              <div class="doctor-profile">
                <div class="doctor-img">
                  <img src="/images/trenntoiletten/trenntoilette-trelino-trelino.webp" alt="Trenntoilette Trelino L"
          ...
          <div class="col-lg-3 col-sm-6 col-md-6 mb-4 shuffle-item" data-groups="['haus', 'camping']">
            <div class="position-relative doctor-inner-box">
              <div class="doctor-profile">
                <div class="doctor-img">
          ...
          <div class="col-lg-3 col-sm-6 col-md-6 mb-4 shuffle-item" data-groups="['camping']">
            <div class="position-relative doctor-inner-box">
              ...
              <div class="content mt-3">
                <h4 class="mb-0"><a href="/trelino-evo-s/" title="Trelino Trelino">Trelino Evo S</a></h4>
                <p class="lead">Trelino</p>
              </div>
            </div>
          </div>
