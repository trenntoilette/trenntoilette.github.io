                ...
                <div class="collapse navbar-collapse" id="navbarmain">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active">
                            <a class="nav-link" title="Trenntoilette" href="https://www.trenntoilette.net">Startseite</a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="#sieger">Testsieger</a>
                        </li>
                        <li class="nav-item active"><a class="nav-link" title="Gartentoiletten im Test" href="/gartentoilette/">Gartentoilette</a></li>
                        <li class="nav-item active"><a class="nav-link" title="Campingtoiletten im Test" href="/campingtoilette/">Campingtoilette</a></li>
        ...
        <div class="container">
                    ...
                    <div class="widget mb-5 mb-lg-0">
                        ...
                        <ul class="list-inline mt-4">
                            <li class="list-inline-item">
                                <a href="https://twitter.com/trenntoilette" title="Trenntoilette.net auf Twitter"><img src="images/social/twitter.webp"></a>
                            </li>
                            <li class="list-inline-item">
                                <a href="https://www.youtube.com/channel/UCW_GsjtxFO8Jb3UJ2z2bpgw" title="Trenntoilette.net auf Youtube"><img src="images/social/youtube.webp"></a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="widget widget-contact mb-5 mb-lg-0">
                        ...
                        <div class="footer-contact-block mb-4">
                            ...
                            <h4 class="mt-2"><a href="mailto:trenntoilette@protonmail.com">kontakt@trenntoilette.net</a>
                            </h4>
                        </div>
                        ...
                        <div class="footer-contact-block">
                            ...
                            <h4 class="mt-2"><a href="tel:+4915111243129">+49 1511 12 43 12 9</a></h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="footer-btm py-4 mt-5">
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6">
                        <div class="copyright">
                            &copy; Copyright by <a href="https://www.trenntoilette.net" title="Trenntoilette">Trenntoilette.net</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
