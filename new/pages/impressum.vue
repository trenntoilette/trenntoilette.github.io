            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="department-content mt-5">
                        ...
                        <p>Die Leon Breitschneider ist Betreiber der unter trenntoilette.net abrufbaren
                            Website. Wir nehmen den Schutz deiner persönlichen Daten sehr ernst und halten uns strikt an
                            die Regeln der Datenschutzgesetze. Personenbezogene Daten werden auf dieser Seite nur im
                            technisch notwendigen Umfang erhoben. In keinem Fall werden die erhobenen Daten verkauft.
                            Eine Weitergabe der Daten erfolgt nur unter den engen gesetzlich zulässigen Voraussetzungen.

                            Wir sind verantwortlich für die Erhebung, Verarbeitung und Nutzung deiner persönlichen Daten
                            im Sinne der Datenschutz-Grundverordnung (DSGVO), wenn du die Website besuchst. Der Schutz
                            deiner personenbezogenen Daten bei der Erhebung, Verarbeitung und Nutzung ist uns ein
                            wichtiges Anliegen. Die nachfolgende Erklärung gibt dir einen Überblick darüber, wie der
                            Schutz deiner personenbezogenen Daten gewährleistet wird und welche Art von Daten zu welchem
                            Zweck erhoben werden. Solltest du Fragen haben, kannst du dich jederzeit per E-Mail an uns
                            wenden: trenntoilette (at) protonmail.com.</p>
                        <p>Name und Kontaktdaten des für die Verarbeitung Verantwortlichen
                        ...
                        <p>Möchtest du von deinem Widerspruchsrecht Gebrauch machen, genügt eine E-Mail an: trenntoilette@protonmail.com.</p>
                        ...
                        <p>Durch die stetige Weiterentwicklung dieser Internetseite oder/und aufgrund geänderter gesetzlicher oder behördlicher Bestimmungen kann es notwendig werden, diese Datenschutzerklärung zu aktualisieren. Die jeweils aktuelle Datenschutzerklärung kann jederzeit auf unserer Website unter https://trenntoilette.net/impressum von dir abgerufen werden.</p>
                    </div>
                </div>
            </div>
        </div>
